(() => {
      ...
      61: (t, e, r) => {
        ...
        function o() {
          ...
          var g = Object.getPrototypeOf,
            x = g && g(g(q([])));
          x && x !== r && i.call(x, c) && (y = x);
          var L = (m.prototype = v.prototype = Object.create(y));
          function E(t) {
  ...
  (r.n = (t) => {
    ...
    (() => {
      ...
      function m() {
        var t,
          e = document.querySelector(".numeros");
        (t = new MutationObserver(function (e) {
          e[0].target.classList.contains("ativo") &&
            (t.disconnect(),
            document.querySelectorAll("[data-numero]").forEach(function (t) {
              var e = +t.innerText,
                r = Math.floor(e / 100),
                n = 0,
                o = setInterval(function () {
                  (n += r),
                    (t.innerText = n),
                    n > e && ((t.innerText = e), clearInterval(o));
                }, 25 * Math.random());
            }));
      ...
      !(function () {
        ...
        (function () {
          var t = document.querySelectorAll("[data-anime='scroll']"),
            e = 0.7 * window.innerHeight;
          function r() {
        ...
        (function () {
          var t = document.querySelectorAll("[data-anime='accordion'] dt"),
            e = "ativo";
          function r() {
            this.classList.toggle(e),
              this.nextElementSibling.classList.toggle(e);
          }
          t.length &&
            (t[0].classList.add(e),
        ...
        (o = document.querySelectorAll("[data-tab='menu'] li")),
        (i = document.querySelectorAll("[data-tab='content'] section")),
        o.length &&
          i.length &&
          (i[0].classList.add("ativo"),
          o.forEach(function (t, e) {
            t.addEventListener("click", function () {
              !(function (t) {
                ...
                var e = i[t].dataset.anime;
                i[t].classList.add("ativo", e);
              })(e);
            });
          })),
        (function () {
          var t = document.querySelector('[data-modal="abrir"]'),
            ...
            e = {
              handleEvent: function (t) {
                (this.tooltipBox.style.top = "".concat(t.pageY + 20, "px")),
                  (this.tooltipBox.style.left = "".concat(t.pageX + 20, "px"));
              },
            },
            r = {
        ...
        (function () {
          function e(e) {
            ...
            e.preventDefault(),
              ...
              t(this, ["touchstart", "click"], function () {
        ...
        (function () {
          var e = document.querySelector('[data-menu="button"]'),
            r = document.querySelector('[data-menu="list"]'),
            n = ["click", "touchstart"];
          function o() {
            r.classList.add("active"),
              e.classList.add("active"),
              t(r, n, function () {
                r.classList.remove("active"), e.classList.remove("active");
              });
          }
          e &&
        ...
        (c = (a = document.querySelector("[data-semana]")).dataset.semana
          .split(",")
          .map(Number)),
        (u = a.dataset.horario.split(",").map(Number)),
        (l = (s = new Date()).getDay()),
        (f = s.getHours()),
        (d = -1 !== c.indexOf(l)),
        (h = f >= u[0] && f < u[1]),
        d && h && a.classList.add("aberto"),
        (function () {
          function t(t) {
            var e = document.createElement("div");
            return (
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (e.prev = 0), (e.next = 3), fetch(r);
                        case 3:
                          return (n = e.sent), (e.next = 6), n.json();
                        case 6:
                          (o = e.sent),
                            (i = document.querySelector(".numeros-grid")),
